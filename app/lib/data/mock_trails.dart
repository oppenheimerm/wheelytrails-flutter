...
final List<Trail> mockTrails = [
  const Trail(
    ...
    description: 'A gentle paved path around the serene lake, perfect for a relaxing afternoon roll.',
  ...
  const Trail(
    ...
    description: 'Immerse yourself in nature with this gravel loop through the dense forest.',
    surfaceType: SurfaceType.gravel,
    location: 'Whispering Woods',
    distance: 5.2,
    difficulty: DifficultyLevel.moderate,
    imageUrl: 'https://images.unsplash.com/photo-1448375240586-dfd8d395ea6c?q=80&w=2670&auto=format&fit=crop',
  ),
  const Trail(
    id: '3',
    name: 'Rocky Ridge Climb',
    description: 'Challenge your skills on this uneven dirt track with stunning panoramic views.',
  ...
  const Trail(
    id: '4',
    name: 'Meadow Breeze',
    description: 'Roll through open grassy fields with wildflowers on this flat and wide trail.',
    surfaceType: SurfaceType.grass,
    location: 'Sunnydale Meadows',
    distance: 2.1,
    difficulty: DifficultyLevel.easy,
    imageUrl: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?q=80&w=2574&auto=format&fit=crop',
  ),
  const Trail(
    id: '5',
    name: 'Coastal Boardwalk',
    description: 'Enjoy the ocean breeze on this sturdy wooden boardwalk along the coast.',
    surfaceType: SurfaceType.paved,
